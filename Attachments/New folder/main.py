...
class ManageTab(QWidget):
    ...
    def add_face(self):
        if self.backend.face_net is None: QMessageBox.critical(self, "Error", "Face detection model not loaded."); return
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.init_ui(); self.setStyleSheet(get_stylesheet())
        self.check_models(); self.update_model_status()
